...
product; this choice was made explicitly to enable Lean to formalize it with an empty axiom set. The advantage is that the resulting program, once complete, will emit certified brackets of physical quantities which are directly comparable to Montecarlo and experimental results.
