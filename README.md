...
In order to ensure strict compliance to the constructive criteria during development and transcription, the TeX and Lean are formulated in what could be described as a carefully designed domain specific language (or less charitably described as an unconventional idiolect). This presentation makes them largely inaccessible in their current form, which is a known and considered limitation, and the conventional presentation is a planned deliverable. Because of this, the repository should not be taken to be ready for a general audience, nor should the current form be considered as a publication-ready format by the author's own standard.
