...
In order to ensure strict compliance to the constructive criteria during development and transcription, the TeX and Lean are written in a non-conventional idiolect which makes them largely inaccessible in their current form. This is a known limitation and a conventional presentation is a planned deliverable. Because of this, the repository should not be taken to be ready for a general audience, nor should the current form be considered as a publication-ready format by the author's own standard.
