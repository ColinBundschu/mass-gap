...
product; this choice was made explicitly to enable Lean to formalize it with an empty axiom set and emit certified brackets of physical quantities directly comparable to Montecarlo and experimental results.
