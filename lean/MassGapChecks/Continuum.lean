...
theorem pin1 : siteCount (7, 1) 2 1 = some 3 := by decide +kernel
theorem pin2 : siteCount (7, 2) 2 1 = some 1 := by decide +kernel
theorem pin3 : siteCount (1, 1) 2 1 = none := by decide +kernel
theorem pin4 : (2 : Pos) * 1 * 3 ≤ 7 * 1 ∧ (7 : Pos) * 1 < 2 * 1 * ground.succ 3 :=
  siteCount_read (7, 1) 2 1 3 (by decide +kernel)
theorem pin5 : (1 : Pos) * 1 < 2 * 1 :=
  siteCount_vac (1, 1) 2 1 (by decide +kernel)

private def dA : Datum := ⟨[(7, 1), (3, 1)], [(5, 2)], [(1, 3)]⟩

theorem pin6 : siteCounts dA 2 1 = [some 3, some 1] := by decide +kernel

/-! ## The stabilization across a scale bracket -/

private def dB : Datum := ⟨[(3, 1), (1, 1)], [], []⟩

theorem pin7 : countsStable dB 2 1 3 1 := by decide +kernel
theorem pin8 : siteCounts dB 5 2 = siteCounts dB 2 1 := by decide +kernel
theorem pin9 : siteCounts dB 5 2 = siteCounts dB 2 1 :=
...
theorem pin10 : ¬ countsStable dA 2 1 3 1 := by decide +kernel
theorem pin11 : ¬ (siteCounts dA 5 2 = siteCounts dA 2 1) := by decide +kernel

/-- The upper end's comparison is load-bearing: beyond the bracket
the counts move. -/
theorem pin12 : ¬ ((4 : Pos) * 1 ≤ 3 * 1) := by decide +kernel
theorem pin13 : ¬ (siteCounts dB 4 1 = siteCounts dB 2 1) := by decide +kernel

/-- The lower end's comparison is load-bearing: below the bracket
the counts move. -/
theorem pin14 : ¬ ((2 : Pos) * 1 ≤ 1 * 1) := by decide +kernel
theorem pin15 : ¬ (siteCounts dB 1 1 = siteCounts dB 2 1) := by decide +kernel
...
theorem pin16 : splitRead (gramM gL) gSp := by decide +kernel
theorem pin17 : psdAt gSp := by decide +kernel
theorem pin18 : psdAt gSp := gram_psd gL 2 (by decide +kernel) gSp (by decide +kernel)
...
theorem pin19 : splitRead (gramM gR) (mkSplit 2 (gramM gR)) := by decide +kernel
theorem pin20 : psdAt (mkSplit 2 (gramM gR)) := by decide +kernel

/-- A symmetric datum off the Gram shape counts a reversal. -/
private def gN : Mat := [[⟨2, 1⟩, ⟨4, 1⟩], [⟨4, 1⟩, ⟨2, 1⟩]]

theorem pin21 : splitRead gN (mkSplit 2 gN) := by decide +kernel
theorem pin22 : ¬ psdAt (mkSplit 2 gN) := by decide +kernel
...
theorem pin23 : l3.map (fun r => (r.1, r.2.1)) = roots3 := by decide +kernel

theorem pin24 : split.rootsAtKernel roots3 ≤ split.rootsBelow roots3 8 1 := by
  decide +kernel
theorem pin25 : split.rootsAtKernel roots3 ≤ split.rootsBelow roots3 8 1 :=
  split.kernel_le_below roots3 8 1

theorem pin26 : matOneValue et3
    (siteDatum (matAdd h3 (matScale 1 (idMat 3))) (matScale 6 (idMat 3))) := by
  decide +kernel
theorem pin27 : split.diagRead et3 (idMat 3) id3 id3 l3 := by decide +kernel
theorem pin28 : split.rootsAtKernel roots3 = 1 := by decide +kernel

private def spT : Split 3 :=
  mkSplit 3 (siteDatum (matAdd h3 (matScale 1 (idMat 3))) (matScale 16 (idMat 3)))

theorem pin29 : countAtPair h3 (idMat 3) 16 1 1 spT := by decide +kernel
theorem pin30 : (10 : Pos) + (1 + 6) = 16 + 1 := by decide +kernel

private def spT' : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 et3) (matScale 10 (idMat 3)))

theorem pin31 : split.countRead et3 (idMat 3) roots3 10 1 spT' := by decide +kernel

private def spC : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 (matMul et3 et3)) (matScale (4 * 2) et3))

theorem pin32 : splitRead (siteDatum (matScale 1 (matMul et3 et3))
    (matScale (4 * 2) et3)) spC := by decide +kernel

theorem pin33 : speccut.cutTie et3 (l3.map (fun r => (r.1, r.2.1))) 4 2 1 spC :=
...
theorem pin34 : split.countRead et3 (idMat 3) roots3 20 1 spT20 := by decide +kernel
theorem pin35 : ¬ ((20 : Pos) + (1 + 6) = 16 + 1) := by decide +kernel
theorem pin36 : (7 : Pos) * 2 * 1 ≤ 20 * 1 := by decide +kernel

private def spC14 : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 (matMul et3 et3)) (matScale (7 * 2) et3))

theorem pin37 : splitRead (siteDatum (matScale 1 (matMul et3 et3))
    (matScale (7 * 2) et3)) spC14 := by decide +kernel
theorem pin38 : ¬ speccut.cutTie et3 roots3 7 2 1 spC14 := by decide +kernel
...
theorem pin39 : ¬ matOneValue et9
    (siteDatum (matAdd h3 (matScale 1 (idMat 3))) (matScale 6 (idMat 3))) := by
  decide +kernel
theorem pin40 : split.diagRead et9 (idMat 3) id3 id3 l9 := by decide +kernel
theorem pin41 : split.rootsAtKernel roots9 = 1 := by decide +kernel

private def spT9 : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 et9) (matScale 10 (idMat 3)))

theorem pin42 : split.countRead et9 (idMat 3) roots9 10 1 spT9 := by decide +kernel
theorem pin43 : (9 : Pos) * 1 * 1 ≤ 10 * 1 := by decide +kernel

private def spC9 : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 (matMul et9 et9)) (matScale (9 * 1) et9))

theorem pin44 : splitRead (siteDatum (matScale 1 (matMul et9 et9))
    (matScale (9 * 1) et9)) spC9 := by decide +kernel
theorem pin45 : ¬ speccut.cutTie et9 roots9 9 1 1 spC9 := by decide +kernel

/-- The edge comparison is load-bearing: the edge `[13 : 1]` beyond
the line's gap level refuses the cut tie. -/
theorem pin46 : ¬ ((13 : Pos) * 1 * 1 ≤ 10 * 1) := by decide +kernel

private def spC13 : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 (matMul et3 et3)) (matScale (13 * 1) et3))

theorem pin47 : splitRead (siteDatum (matScale 1 (matMul et3 et3))
    (matScale (13 * 1) et3)) spC13 := by decide +kernel
theorem pin48 : ¬ speccut.cutTie et3 roots3 13 1 1 spC13 := by decide +kernel
...
theorem pin49 : matOneValue et4
    (siteDatum (matAdd h3 (matScale 1 (idMat 3))) (matScale 5 (idMat 3))) := by
  decide +kernel
theorem pin50 : split.diagRead et4 (idMat 3) id3 id3 l4 := by decide +kernel
theorem pin51 : ¬ (split.rootsAtKernel roots4 = 1) := by decide +kernel
theorem pin52 : (11 : Pos) + (1 + 5) = 16 + 1 := by decide +kernel

private def spT4 : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 et4) (matScale 11 (idMat 3)))

theorem pin53 : split.countRead et4 (idMat 3) roots4 11 1 spT4 := by decide +kernel
theorem pin54 : (4 : Pos) * 2 * 1 ≤ 11 * 1 := by decide +kernel

private def spC4 : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 (matMul et4 et4)) (matScale (4 * 2) et4))

theorem pin55 : splitRead (siteDatum (matScale 1 (matMul et4 et4))
    (matScale (4 * 2) et4)) spC4 := by decide +kernel
theorem pin56 : ¬ speccut.cutTie et4 roots4 4 2 1 spC4 := by decide +kernel
...
theorem pin57 : matOneValue etX
    (siteDatum (matAdd hX (matScale 1 (idMat 3))) (matScale 6 (idMat 3))) := by
  decide +kernel
theorem pin58 : split.diagRead etX (idMat 3) id3 id3 lX := by decide +kernel
theorem pin59 : split.rootsAtKernel rootsX = 1 := by decide +kernel
theorem pin60 : ¬ countAtPair hX (idMat 3) 16 1 1
...
theorem pin61 : split.countRead etX (idMat 3) rootsX 10 1 spTX := by decide +kernel

private def spCX : Split 3 :=
  mkSplit 3 (siteDatum (matScale 1 (matMul etX etX)) (matScale (4 * 2) etX))

theorem pin62 : splitRead (siteDatum (matScale 1 (matMul etX etX))
    (matScale (4 * 2) etX)) spCX := by decide +kernel
theorem pin63 : ¬ speccut.cutTie etX rootsX 4 2 1 spCX := by decide +kernel

/-! ## The edge's floor clearance -/

theorem pin64 : (16 : Pos) + 1 ≤ 10 + (1 + 10) := by decide +kernel
theorem pin65 : (16 : Pos) + 1 ≤ 10 + (1 + 10) :=
...
theorem pin66 : ¬ ((6 : Pos) + 1 ≤ 3 + 1) := by decide +kernel
theorem pin67 : ¬ ((16 : Pos) + 1 ≤ 10 + (1 + 3)) := by decide +kernel

/-- The line's tie is load-bearing: at a gap level off the tie the
lines' gap parts from it. -/
theorem pin68 : ¬ ((1 : Pos) + (1 + 6) = 16 + 1) := by decide +kernel
theorem pin69 : ¬ ((16 : Pos) + 1 ≤ 1 + (1 + 10)) := by decide +kernel
