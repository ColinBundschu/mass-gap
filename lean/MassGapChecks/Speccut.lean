...
theorem pin1 : split.chiRead et3 (idMat 3) roots3 := by decide +kernel
theorem pin2 : specRead roots3 4 3 1 := by decide +kernel
theorem pin3 : ¬ specRead roots3 4 4 1 := by decide +kernel
...
theorem pin4 : cutTie et3 roots3 4 3 1 spCut := by decide +kernel
...
theorem pin5 : l3.map (fun r => (r.1, r.2.1)) = roots3 := by decide +kernel
theorem pin6 : split.diagRead et3 (idMat 3) id3 id3 l3 := by decide +kernel
...
theorem pin9 : splitRead et3 spGap := by decide +kernel
theorem pin10 : psdAt spGap := by decide +kernel

theorem pin11 : specRead (l3.map (fun r => (r.1, r.2.1))) 4 3 1 :=
...
theorem pin12 : specRead (l3.map (fun r => (r.1, r.2.1))) 4 3 1 := by decide +kernel
...
theorem pin13 : ¬ specRead (l3.map (fun r => (r.1, r.2.1))) 4 4 1 := by decide +kernel

theorem pin14 : splitRead (siteDatum (matScale (1 : Pos) (matMul et3 et3))
    (matScale ((4 : Pos) * 4) et3)) spBeyond := by decide +kernel

theorem pin15 : ¬ psdAt spBeyond := by decide +kernel
...
theorem pin16 : split.diagRead et1 (idMat 1) t1 t1w l1 := by decide +kernel

theorem pin17 : splitRead (siteDatum (matScale (1 : Pos) (matMul et1 et1))
    (matScale ((1 : Pos) * 1) et1)) sp1 := by decide +kernel

theorem pin18 : psdAt sp1 := by decide +kernel

theorem pin19 : ¬ specRead (l1.map (fun r => (r.1, r.2.1))) 1 1 1 := by decide +kernel
...
theorem pin20 : splitRead et1 spGap1 := by decide +kernel
theorem pin21 : ¬ psdAt spGap1 := by decide +kernel
